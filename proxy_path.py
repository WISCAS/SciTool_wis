...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QDesktopWidget, QLabel, QGridLayout, QTextBrowser
...
class Ui_MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.tips_1 = QTextBrowser()
        self.tips_1.setText("测试")
        ...
        grid.addWidget(self.btn_webbrowser, 0, 0)
        grid.addWidget(self.tips_1, 0, 1,2,1)
    ...
    def btn_webbrowser_Clicked(self):
        webbrowser.open('https://www.crossref.org/')
